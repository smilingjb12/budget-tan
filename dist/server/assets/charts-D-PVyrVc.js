import { a as reactExports, o as jsxRuntimeExports, g as getDefaultExportFromCjs, R as React, i as invariant } from "../server.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardContent } from "./card-3t2RcMMr.js";
import { r as reactDomExports } from "./router-BgvrDMcr.js";
import { g as composeRefs, h as useControllableState, c as createContextScope, i as useId, u as useComposedRefs, j as useLayoutEffect2, P as Primitive, a as composeEventHandlers, k as Portal$1, l as useCallbackRef, m as hideOthers, n as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, o as useExpenseCategoriesQuery, p as useCategoryExpensesQuery, q as useMonthlyExpensesVsIncomeQuery, r as useIncomeTrendsQuery } from "./queries-DSf7RaaT.js";
import { c as createPopperScope, u as useDirection, R as Root2$1, a as createCollection, V as VISUALLY_HIDDEN_STYLES, A as Anchor, C as Content, b as Arrow } from "./index-BjavhTma.js";
import { c as cn, f as formatCurrency } from "./utils-yaVLMgP5.js";
...
const SelectTriggerNoChevron = reactExports.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Trigger,
  {
    ref,
    className: cn(
...
var warn$1 = function warn(condition, format2) {
...
var warn2 = function warn3(condition, format2, a2, b, c2, d, e, f) {
...
var minPointSizeCallback = function minPointSizeCallback2(minPointSize) {
  ...
  return function(value, index) {
    ...
    !isValueNumberOrNil ? process.env.NODE_ENV !== "production" ? invariant(false, "minPointSize callback function received a value with type of ".concat(_typeof$e(value), ". Currently only numbers or null/undefined are supported.")) : invariant(false) : void 0;
    return defaultValue;
  };
};
...
var useXAxisOrThrow = function useXAxisOrThrow2(xAxisId) {
  ...
  !(xAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find xAxis by id "'.concat(xAxisId, '" [').concat(_typeof$b(xAxisId), "]. ").concat(getKeysForDebug(xAxisMap))) : invariant(false) : void 0;
  return xAxis;
};
...
var useYAxisOrThrow = function useYAxisOrThrow2(yAxisId) {
  ...
  !(yAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find yAxis by id "'.concat(yAxisId, '" [').concat(_typeof$b(yAxisId), "]. ").concat(getKeysForDebug(yAxisMap))) : invariant(false) : void 0;
  return yAxis;
};
...
function transformMonthlyDataForChart(data) {
...
function ExpenseTrendsChart() {
  ...
  const { data: categories, isLoading: isCategoriesLoading } = useExpenseCategoriesQuery();
  const { data: rawCategoryExpenses, isLoading: isExpensesLoading } = useCategoryExpensesQuery(selectedCategoryId || 0);
  ...
  const [visibleData, setVisibleData] = reactExports.useState([]);
  const [, setVisibleRange] = reactExports.useState({ start: 0, end: 0 });
  const [, setCurrentYear] = reactExports.useState(null);
  const minChartWidth = categoryExpenses?.length ? Math.max(categoryExpenses.length * 60, 300) : 300;
  const updateVisibleData = reactExports.useCallback(() => {
  ...
  reactExports.useEffect(() => {
    if (chartContainerRef.current && categoryExpenses?.length && !isExpensesLoading && selectedCategoryId) {
      setTimeout(() => {
  ...
  const getYearDividers = () => {
    ...
    return categoryExpenses.filter((item) => item.isFirstMonthOfYear).map((item) => ({
  ...
  const getBarColor = (value, data) => {
    ...
    const range3 = maxValue - minValue;
    const normalizedValue = range3 === 0 ? 0.5 : (value - minValue) / range3;
    const colorStops = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Expense Trends" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-full max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select a category" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: isCategoriesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "loading", disabled: true, children: "Loading categories..." }) : categories?.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: category.id.toString(), children: category.name }, category.id)) })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: selectedCategoryId ? isExpensesLoading || !categoryExpenses ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Loading chart data..." }) }) : categoryExpenses && categoryExpenses.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: `${minChartWidth}px`, height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            BarChart,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  YAxis,
                  {
                    ...
                    domain: visibleData && visibleData.length > 0 ? [
                      0,
                      Math.max(
                ...
                yearDividers.map((divider) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ReferenceLine,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Bar, { dataKey: "total", radius: [4, 4, 0, 0], maxBarSize: 40, children: [
                  categoryExpenses && categoryExpenses.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Cell,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    LabelList,
                    {
                      dataKey: "total",
                      position: "top",
                      formatter: (value) => formatCurrency(Math.round(Number(value) || 0)).replace(/\.\d+/, ""),
                      style: {
                        fontSize: "12px",
                        fill: "white",
                        fontWeight: "normal"
          ...
          ) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No data available for this category" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Select a category to view expense trends" }) })
        }
      )
    ] })
  ] });
}
function transformMonthlyExpensesVsIncomeForChart(data) {
  if (!data || !Array.isArray(data)) {
    return [];
  }
  return data.map((item) => {
...
function ExpensesVsIncomeChart() {
  ...
  const [hasInitiallyScrolled, setHasInitiallyScrolled] = reactExports.useState(false);
  ...
  const chartContainerRef = reactExports.useRef(null);
  const [, setVisibleData] = reactExports.useState([]);
  const [, setVisibleRange] = reactExports.useState({ start: 0, end: 0 });
  const [, setCurrentYear] = reactExports.useState(null);
  const minChartWidth = expensesVsIncome?.length ? Math.max(expensesVsIncome.length * 60, 300) : 300;
  const updateVisibleData = reactExports.useCallback(() => {
  ...
  reactExports.useEffect(() => {
    if (chartContainerRef.current && expensesVsIncome?.length && !isLoading && !hasInitiallyScrolled) {
      setTimeout(() => {
        if (chartContainerRef.current) {
          chartContainerRef.current.scrollLeft = chartContainerRef.current.scrollWidth;
          updateVisibleData();
  ...
  const getYearDividers = () => {
    ...
    return expensesVsIncome.filter((item) => item.isFirstMonthOfYear).map((item) => ({
      yearMonth: item.yearMonth,
      year: item.year
    }));
  };
  ...
  const CustomTooltip = (props) => {
    ...
    if (active && payload && payload.length > 0) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background/90 p-2 border border-border rounded-md shadow-md text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: `${label} ${year}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-500", children: `Expenses: ${formatCurrency(
          expenseValue || 0
        )}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-500", children: `Income: ${formatCurrency(
          incomeValue || 0
        )}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: `font-medium ${differenceValue >= 0 ? "text-green-500" : "text-red-500"}`,
            children: `Balance: ${formatCurrency(differenceValue || 0)}`
          }
        )
      ] });
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Income vs Expenses" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        className: "h-[300px] overflow-x-auto",
        onScroll: updateVisibleData,
        children: isLoading || !expensesVsIncome ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Loading chart data..." }) }) : expensesVsIncome && expensesVsIncome.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: `${minChartWidth}px`, height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            ...
            children: [
              ...
              yearDividers && yearDividers.map((divider) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                ReferenceLine,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Bar,
                {
                  ...
                  radius: [4, 4, 0, 0],
                  maxBarSize: 40,
                  children: expensesVsIncome && expensesVsIncome.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Cell,
                    {
                      fill: entry.difference >= 0 ? "hsl(142, 76%, 36%)" : "hsl(35, 84%, 60%)"
                    },
                    `cell-${index}`
                  ))
                }
        ...
        ) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No income vs expenses data available" }) })
      }
    ) })
  ] });
}
...
function transformIncomeTrendsForChart(data) {
  if (!data || !Array.isArray(data)) {
  ...
  data.forEach((item) => {
    ...
    monthlyData[item.monthDate].categories[item.categoryName] = (monthlyData[item.monthDate].categories[item.categoryName] || 0) + item.total;
  ...
  chartData.sort((a2, b) => a2.yearMonth.localeCompare(b.yearMonth));
  return {
    data: chartData,
    categories: Array.from(categories).sort()
  };
}
function IncomeTrendsChart() {
  ...
  reactExports.useEffect(() => {
    if (chartContainerRef.current && incomeTrendsData.data?.length && !isLoading && !hasInitiallyScrolled) {
      setTimeout(() => {
        if (chartContainerRef.current) {
          chartContainerRef.current.scrollLeft = chartContainerRef.current.scrollWidth;
          updateVisibleData();
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Income Trends" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Loading chart data..." }) }) })
    ] });
  }
  if (!rawIncomeTrendsData || !Array.isArray(rawIncomeTrendsData) || rawIncomeTrendsData.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Income Trends" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No income data available" }) }) })
    ] });
  }
  if (!incomeTrendsData.data || incomeTrendsData.data.length === 0 || !incomeTrendsData.categories || incomeTrendsData.categories.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Income Trends" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Unable to process income data" }) }) })
    ] });
  }
  const minChartWidth = incomeTrendsData.data?.length ? Math.max(incomeTrendsData.data.length * 60, 300) : 300;
  const CustomTooltip = (props) => {
    const { active, payload, label } = props;
    if (active && payload && payload.length > 0) {
      const dataPoint = payload[0].payload;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background/90 p-2 border border-border rounded-md shadow-md text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: `${label} ${dataPoint.year}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-primary mb-1", children: `Total: ${formatCurrency(dataPoint.total)}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: payload.filter((entry) => entry.value > 0).map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        className: "h-[300px] overflow-x-auto",
        onScroll: updateVisibleData,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: `${minChartWidth}px`, height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, {}),
              incomeTrendsData.categories.map((category, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Bar,
                {
                  dataKey: category,
                  stackId: "income",
...
const renderCustomizedLabel = (props) => {
  const { x: x2, y: y2, width, value } = props;
  const xPos = Number(x2 || 0);
  const yPos = Number(y2 || 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "text",
    {
      ...
      children: formatCurrencyNoDecimals(numValue)
    }
  );
};
function transformIncomeTrendsToYearly(data) {
  if (!data || !Array.isArray(data)) {
    return { data: [], categories: [] };
  }
  ...
  const yearlyData = Object.values(yearlyAggregation).sort((a2, b) => a2.year.localeCompare(b.year)).map((item) => {
    const result = {
      name: item.name,
      year: item.year,
      total: item.total,
...
function IncomeByYearChart() {
  ...
  const CustomTooltip = (props) => {
    ...
    if (active && payload && payload.length > 0) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background border border-border p-2 rounded-md shadow-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold", children: `Year: ${label}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-primary", children: `Total: ${formatCurrency(
          typedPayload[0]?.payload?.total || 0
        )}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: typedPayload.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-3 h-3 rounded-full",
  ...
  const maxValue = reactExports.useMemo(() => {
    ...
    const max2 = Math.max(...incomeTrendsData.data.map((item) => item.total));
    return max2 * 1.2;
  }, [incomeTrendsData.data]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Income by Year" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px]", children: isLoading || !incomeTrendsData.data ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Loading chart data..." }) }) : incomeTrendsData.data && incomeTrendsData.data.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      BarChart,
      {
        data: incomeTrendsData.data,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, {}),
          incomeTrendsData?.categories && Array.isArray(incomeTrendsData.categories) && incomeTrendsData.categories.length > 0 ? incomeTrendsData.categories.map((category, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Bar,
            {
              dataKey: category,
              stackId: "a",
              fill: COLORS[index % COLORS.length],
              radius: index === (incomeTrendsData.categories?.length || 0) - 1 ? [4, 4, 0, 0] : [0, 0, 0, 0],
              maxBarSize: 80,
              children: index === (incomeTrendsData.categories?.length || 0) - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                LabelList,
                {
                  dataKey: "total",
                  position: "top",
    ...
    ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No income data available" }) }) }) })
  ] });
}
function ChartsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold mb-6 px-4 py-2", children: "Charts" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ExpenseTrendsChart, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ExpensesVsIncomeChart, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IncomeTrendsChart, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IncomeByYearChart, {})
  ] });
}
export {
