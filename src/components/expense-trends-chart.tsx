...
function transformMonthlyDataForChart(data: MonthlyTotalsDto[]) {
...
export function ExpenseTrendsChart() {
  ...
  const { data: categories, isLoading: isCategoriesLoading } =
    useExpenseCategoriesQuery();
  const { data: rawCategoryExpenses, isLoading: isExpensesLoading } =
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        >
          {selectedCategoryId ? (
            isExpensesLoading || !categoryExpenses ? (
